  ...
  .. list-table:: Mapping Yocto layers to manifest release tags
     ...
     * - 
       ...
       - BSP build + Real-time kernel build:
         ...
         ``qcom-6.6.116-QLI.1.7-Ver.1.0_realtime-linux-1.0.xml``
       - ``qcom-wayland``
     * - 
         - ``meta-qcom``
         - ``meta-qcom-hwe``
...
#. Set up the build environment:
   ...
   For information about the ``MACHINE`` parameter values, see `Release Notes <https://docs.qualcomm.com/doc/80-70023-300/>`__.
...
#. Clone the real-time Linux layer into the workspace:
   ...
   .. container:: nohighlight
      ...
      ::
         ...
         # Example, <meta-qcom-realtime release tag> is qcom-6.6.116-QLI.1.7-Ver.1.0_realtime-linux-1.0
